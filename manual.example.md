...
aria2c -x 16 -s 16 -o <project_name>-pruned-snap.tar.lz4 https://st-snap-1.stakeme.pro/<project_name>/mainnet/pruned/cosmos_data_<project_name>_20250219_110001.tar.lz4
...
tar -I lz4 -xvf ~/<project_name>-pruned-snap.tar.lz4 -C $HOME/.<service_name>
...
rm $HOME/<project_name>-pruned-snap.tar.lz4
